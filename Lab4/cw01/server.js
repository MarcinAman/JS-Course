...
http.createServer(function(request, response) {
    ...
    */
    ...
    if(url_parts.pathname == '/submit') { //Przetwarzanie zawartości formularza, jeżeli względny URL to '/submit' 
        var path=url_parts.query['path']; //Odczytaj zawartość pola (formularza) o nazwie 'imie'
        ...
        response.write(zad2.getPath(path)); //Umieść podane dane (tu: tekst 'Witaj ...') w ciele odpowiedzi
        ...
        response.write('<input name="path">'); //zmiana url-a
        response.write('<br>');
